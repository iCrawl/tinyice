...
const BOTTOM_ITEMS: SidebarItem[] = [
  ...
  { id: 'webhooks', label: 'Webhooks', href: '/admin/webhooks',
    icon: '<path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81"/><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/>' },
